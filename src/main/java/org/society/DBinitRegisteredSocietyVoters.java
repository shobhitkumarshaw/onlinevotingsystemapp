...
public class DBinitRegisteredSocietyVoters implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		registeredSocietyVotersRepository.save(new RegisteredSocietyVoters(100l, "12345", "Mihir", "shaw", "Bcrec", "Male", "obc", "9876543210", "mihir@email.com", "add1", "add23", "mondal", "Dis", 678543, false, null));
