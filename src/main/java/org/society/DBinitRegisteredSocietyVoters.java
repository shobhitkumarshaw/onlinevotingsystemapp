...
public class DBinitRegisteredSocietyVoters implements CommandLineRunner {
	...
	registeredSocietyVotersRepository.save(new RegisteredSocietyVoters(101L,"v22345", "Ashish", "Singh", "Male", "sc", "8521674392", "ashish.singh@yahoo.com", "Rayagada", "Kotepada", "Gunupur", 573942, true, "active", null));
