...
public class DBinitRegisteredSocietyVoters implements CommandLineRunner {
	...
	//registeredSocietyVotersRepository.save(new RegisteredSocietyVoters(100L,"v12345", "Kishore", "Pal", "Male", "st", "5549315672", "kishore.pal@outlook.com", "Japjpur", "Jappur Road", "Bhubhanswer", 634896, false, "active", null));
	//registeredSocietyVotersRepository.save(new RegisteredSocietyVoters(101L,"v56324", "Ashish", "Singh", "Male", "sc", "8521674392", "ashish.singh@yahoo.com", "Rayagada", "Kotepada", "Gunupur", 573942, false, "active", null));
