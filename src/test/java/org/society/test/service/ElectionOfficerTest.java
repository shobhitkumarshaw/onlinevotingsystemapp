...
public class ElectionOfficerTest {
	...
	public void addElectionOfficerDetailsTest() {
		ElectionOfficer officer = new ElectionOfficer("Rahul", "Raj", "Male", "1234567890", "rahul@gmail.com", "add1",
				"add2", "Dis1", 1234);
	...
	public void deleteElectionOfficerDetailsTest() {
		...
		ElectionOfficer officer = new ElectionOfficer("Mohit", "Kumar", "Male", "2234567890", "mohit@gmail.com", "add2",
				"add3", "Dis2", 223456);
		officer.setId(3l);
	...
	public void getElectionOfficerListDetailsTest() {
		...
		ElectionOfficer officer = new ElectionOfficer("Mohit", "Kumar", "Male", "2234567890", "mohit@gmail.com", "add2",
				"add3", "Dis2", 223456);
		ElectionOfficer officer2 = new ElectionOfficer("Rahul", "Raj", "Male", "1234567890", "rahul@gmail.com", "add1",
				"add2", "Dis1", 123456);
