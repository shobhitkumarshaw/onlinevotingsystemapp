...
public class NominatedCandidatesTest {
	...
	public void addNominatedCandidatesDetailsTest() {
		CooperativeSociety cs1 = new CooperativeSociety("A Society", "HeadNominatedCandidate1", "Sathpur",
				"Gandhi Nagar", "Jajapur", "123456", null, null);
		RegisteredSocietyVoters rs1 = new RegisteredSocietyVoters(200l, "v12345", "Mihir", "shaw", "Male", "obc",
				"9876543210", "mihir@email.com", "Orissa", "Gandhi Nagar", "Jajapur", 123456, true, "active", cs1);
	...
	public void updateNominatedCandidatesDetailsTest() {
		CooperativeSociety cs2 = new CooperativeSociety("B Society", "HeadNominatedCandidate12", "Motipur",
				"Mouna Nagar", "Saran", "223456", null, null);
		RegisteredSocietyVoters rs2 = new RegisteredSocietyVoters(300l, "v22345", "Shobbit", "kumar", "Male", "gen",
				"8876543210", "shobbit@email.com", "Chapra", "Mouna Nagar", "Saran", 223456, true, "active", cs2);
		NominatedCandidates nc2 = new NominatedCandidates(222L, "Death", "Fire", 20000, true, true, true, rs2, cs2);
